...
DOCX_PATH = OUT_DIR / "credit-card-mvp-spec-v6-2026-06-05.docx"
TEXT_DUMP = OUT_DIR / "credit-card-mvp-spec-v6-2026-06-05-inspection.txt"
...
p2 = doc.add_paragraph()
style(p2.add_run("版本：2026-06-05 / v6\n本版依 discussion-checklist-0605.md 新增後台銀行管理、信用卡管理、分類管理、優惠管理與設定的對應畫面圖，並延續 v5 的欄位、關聯與 SEO / AI 搜尋規格。"), 11, False, "394651")
...
heading(doc, "11. 本版更新說明", "以下為本版（2026-06-05 / v6）相較上一版 credit-card-mvp-spec-v5-2026-06-05 的新增、修正與補強內容。")
kv_table(doc, [
    ("新增", "新增 7.3 後台各模組畫面圖，包含銀行管理、信用卡管理、分類管理、優惠管理與設定畫面，讓左側選單點擊後的頁面可直接對照畫面。"),
    ("修正", "本版未修改第 9 節技術棧，仍維持 Next.js、Prisma、SQLite、Tailwind CSS；未覆蓋 v5 內容。"),
    ("補強", "補強後台左側選單頁面規格與畫面圖之間的對應關係；優惠管理列表圖與既有單筆優惠編輯圖形成前後流程。"),
    ("版本處理", "新版檔案另存為 credit-card-mvp-spec-v6-2026-06-05.docx，未覆蓋原本的 v5。"),
])
