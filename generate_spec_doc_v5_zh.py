...
ASSET_DIR = OUT_DIR / "assets-v20260605-zh"
DOCX_PATH = OUT_DIR / "credit-card-mvp-spec-v5-2026-06-05.docx"
TEXT_DUMP = OUT_DIR / "credit-card-mvp-spec-v5-2026-06-05-inspection.txt"
...
category_img = ASSET_DIR / "分類頁卡片規則-2026-06-05.png"
detail_img = ASSET_DIR / "詳情頁示意圖-2026-06-05.png"
admin_img = ASSET_DIR / "後台單筆優惠編輯畫面-2026-06-05.png"
...
p2 = doc.add_paragraph()
style(p2.add_run("版本：2026-06-05 / v5\n本版依 discussion-checklist-0605.md 補齊 offers 摘要欄位、優惠與分類關聯規則、後台左側選單頁面規格，以及 SEO 與 AI 搜尋可見性規格。"), 11, False, "394651")
...
heading(doc, "11. 本版更新說明", "以下為本版（2026-06-05 / v5）相較上一版 credit-card-mvp-spec-2026-06-04-v4 的新增、修正與補強內容。")
kv_table(doc, [
    ("新增", "新增後台左側選單各模組點擊後的頁面規格，涵蓋儀表板、銀行管理、信用卡管理、分類管理、優惠管理與設定。新增 SEO 與 AI 搜尋可見性規格，包含固定 URL、SEO metadata、sitemap.xml、robots.txt、JSON-LD、FAQ、來源、更新時間與 alt text。"),
    ("修正", "補齊 offers 核心欄位中的 summary_mode、target_audience、highlight_1、highlight_2、manual_summary、summary_preview，讓第 7 節資料結構與第 6 節列表摘要機制一致。"),
    ("補強", "補充優惠、信用卡與分類的關聯規則，明確說明分類歸屬以 offers 為主，一張信用卡可透過不同優惠出現在多個分類中，offer_cards 為優惠與信用卡的多對多中間表。確認第 9 節維持 Next.js、Prisma、SQLite、Tailwind CSS 的 MVP 輕量技術棧。"),
    ("版本處理", "新版檔案另存為 credit-card-mvp-spec-v5-2026-06-05.docx，未覆蓋原本的 v4。"),
])
