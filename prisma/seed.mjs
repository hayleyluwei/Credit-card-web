...
const offerSeeds = [
  ...
  },
  {
    ...
    title: "DAWHO 國內外最高 6% 現金回饋",
    slug: "dawho-high-cashback-2026",
    summary: "大戶 Plus 等級國內全通路一般消費最高 5%、國外最高 6% 現金回饋。",
    description:
      "DAWHO 現金回饋信用卡用於測試真實資料中等級條件、國內外回饋與回饋上限能否用現有欄位清楚呈現。",
    rewardType: "cashback",
    rewardValue: "國內最高 5% / 國外最高 6%",
    rewardCap: "Plus 等級加碼每月帳單週期上限 NT$1,000；其他等級依官方公告。",
    minSpend: "一般消費，依官方排除項目與入帳規則。",
    conditions: "需綁定 DAWHO 數位帳戶自動扣繳信用卡款，並使用電子或行動帳單且取消紙本帳單。",
    sourceUrl: "https://bank.sinopac.com/sinopacBT/personal/credit-card/introduction/bankcard/DAWHO.html",
    startDate: fixedDate("2026-01-01"),
    endDate: fixedDate("2026-06-30"),
    tags: "DAWHO,永豐,現金回饋,海外消費",
    isFeatured: true,
    recommendScore: 94,
    sortOrder: 80
  },
  {
    ...
    slug: "dawho-easycard-autoload-2026",
    summary: "悠遊卡自動加值最高 5% 回饋，依大戶等級與每月上限計算。",
    description: "用於測試電子票證自動加值這種非一般刷卡情境是否能放在交通通勤分類。",
    rewardType: "cashback",
    rewardValue: "最高 5%",
    rewardCap: "Plus 等級每月最高 NT$500；DAWHO 等級每月最高 NT$100。",
    minSpend: "悠遊卡自動加值交易。",
    conditions: "須符合 DAWHO 信用卡與大戶等級條件，實際認定依永豐官方公告。",
    sourceUrl: "https://bank.sinopac.com/sinopacBT/personal/credit-card/introduction/bankcard/DAWHO.html",
    startDate: fixedDate("2026-01-01"),
    endDate: fixedDate("2026-06-30"),
    tags: "悠遊卡,自動加值,通勤",
