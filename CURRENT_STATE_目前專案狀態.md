...
### T29 情境／攻略／優惠雙向串接 — v1 草案待核准（2026-08-18 建卡）

- 任務卡：`docs/implementation/tasks/T29-CONTENT_CROSSLINKS_情境攻略優惠雙向串接.md`
...
- 6 個待決問題未拍板，其中 (b) 若選「後台明確指定導回目標」會需要新增 `Article` 欄位＝**改 schema，須走 schema 專門流程**。未核准前不得修改任何前台頁面或資料。
