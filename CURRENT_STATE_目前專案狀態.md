...
7. **T20（攻略文章功能與自動情境頁）已升版 v3 待核准**（2026-07-30）：新增自動情境頁（`/scenarios/[slug]`）與人工攻略文章並行，取代先前排除自動聚合頁的決定，核心情境標籤擴充為 14 項，詳見上方 T20 段落；仍建議排 T18 上線後。
