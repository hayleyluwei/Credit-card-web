...
ASSET_DIR = OUT_DIR / "assets-v20260604-zh"
DOCX_PATH = OUT_DIR / "credit-card-mvp-spec-2026-06-04-v4.docx"
TEXT_DUMP = OUT_DIR / "credit-card-mvp-spec-2026-06-04-v4-inspection.txt"
...
category_img = ASSET_DIR / "分類頁卡片規則-2026-06-04.png"
detail_img = ASSET_DIR / "詳情頁示意圖-2026-06-04.png"
admin_img = ASSET_DIR / "後台單筆優惠編輯畫面-2026-06-04.png"
...
p2 = doc.add_paragraph()
style(p2.add_run("版本：2026-06-04 / v4\n本版依 discussion-checklist-0604.md 補回詳情頁示意圖，並重做後台單筆優惠編輯畫面，使畫面欄位與文件規格可逐項對照。"), 11, False, "394651")
...
heading(doc, "11. 本版更新說明", "以下為本版（2026-06-04 / v4）相較上一版 credit-card-mvp-spec-2026-06-03-v3 的新增與補強內容。")
bullets(doc, [
    "補回詳情頁示意圖，並讓示意圖欄位與正文中的詳情頁說明一致。",
    "重做後台單筆優惠編輯畫面，改成可對照欄位名稱、輸入方式、畫面值與用途說明的表單式設計。",
    "後台畫面明確拆成基本資訊、列表摘要設定、排序與上架設定三個區塊，並與正文欄位規格一一對應。",
    "將 highlight_1、highlight_2、is_published、updated_at 等欄位在畫面中獨立呈現，避免與正文規格對不上。",
    "新版檔案另存為日期與版本號格式，未覆蓋原本的 v3。",
])
