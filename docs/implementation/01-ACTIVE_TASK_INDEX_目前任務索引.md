...
| T20 | 攻略文章功能與自動情境頁（AI 可引用性） | v3 已核准（2026-07-30） | 自動驗證通過，待人工驗收（後台文章 CRUD 需使用者登入操作） | 未部署 | T18（建議順序，未強制） | `tasks/T20-GUIDE_ARTICLES_攻略文章功能.md` | `summaries/T20-GUIDE_ARTICLES_SUMMARY-v1-2026-07-30.md` |
