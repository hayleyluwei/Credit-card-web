...
最後更新：2026-08-20（Asia/Taipei，資訊架構收斂完成；規格書出 v8；T29 升 v1.3；新增 T32 資料整理草案）  
...
| T32 | 資料回歸規格整理（第一批） | v1 草案，待核准；5 個待決問題未拍板 | 規劃中（待核准）。A–F 六項**全部寫入正式站資料庫**，屬第三層 | 不適用（資料變更；靜態頁需重新部署才反映） | 規格書 v8-2026-08-20；架構文件 2026-08-20 | `tasks/T32-DATA_ALIGNMENT_資料回歸規格整理.md` | 無 |
