...
| T32 | 資料回歸規格整理（第一批） | **v1.2** 草案，待核准（2026-08-21 整理）；(a) 已由乾跑解決，新增 (f)(g)(h)，**(f) 結論為本卡應排在 T29 之前** | 規劃中（待核准）。**⚠️ 風險等級因 T33 下降**：不再是「直寫正式站、沒有退路」，改為 **dev 演練 → 確認 → production 重放**。**Scope A 已完成唯讀乾跑且 8/21 複查數字仍有效**：影響 12/35 筆、無優惠消失。**Scope C 範圍擴大**：實測至少 5 筆有缺口，另中信 uniopen 4 筆完全零情境標籤 | 不適用（資料變更；靜態頁需重新部署才反映） | 規格書 v9-2026-08-20；架構文件 2026-08-20 | `tasks/T32-DATA_ALIGNMENT_資料回歸規格整理.md` | 無 |
