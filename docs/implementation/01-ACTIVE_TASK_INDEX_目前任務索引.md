...
| T29 | 情境／攻略／優惠雙向串接 | v1 草案，待核准；6 個待決問題未拍板 | 規劃中（待核准） | 不適用 | T20（文章功能與 slug 對應機制已存在）、T28（情境卡文案與 `SCENARIO_COPY` 已建立）；與 T27 的導向規則需一致 | `tasks/T29-CONTENT_CROSSLINKS_情境攻略優惠雙向串接.md` | 無 |
